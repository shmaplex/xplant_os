...
- **Your plan's allowances still apply.** Registering devices beyond your plan's allowance, for example, answers `402 DEVICE_LIMIT_REACHED`. See [plans](https://www.xplantpro.com/en/subscriptions) for what each plan includes.
...
| `402 PAID_PLAN_REQUIRED` | The workspace's plan doesn't include the API. It's included with xPlant+ Teams and Enterprise; see [plans](https://www.xplantpro.com/en/subscriptions). |
