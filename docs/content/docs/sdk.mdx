...
Some newer endpoints aren't in the SDK yet: creating and updating plants and explants, contaminations, comments, media files, media recipes, equipment reads, pricing and sell-through. Their reference pages show a plain `fetch` example instead.
