...
You need an xPlant workspace on **xPlant+ Teams** or **Enterprise**, which include the whole API (Hobby and Pro Lab keys can connect devices only), and a role of `member` or above to grant the scopes below.
...
If you get `401 UNAUTHORIZED`, the key is wrong or has been revoked. If you get `402 PAID_PLAN_REQUIRED`, your workspace's plan doesn't include this call; see [Plans and access](/docs/authentication#plans-and-access).
