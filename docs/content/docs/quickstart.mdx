...
You need an xPlant workspace on **xPlant+ Teams** or **Enterprise**, which include the API, and permission to manage its integrations.
...
If you get `401 UNAUTHORIZED`, the key is wrong or has been revoked. If you get `402 PAID_PLAN_REQUIRED`, your workspace's plan doesn't include the API; see [plans](https://www.xplantpro.com/en/subscriptions).
